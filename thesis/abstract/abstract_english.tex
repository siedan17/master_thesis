...
\usepackage[english]{babel} % deutsche Bezeichnungen und Worttrennung… 
...
\begin{centering}
\Large{Title:}\\
\Large{Testing of different machine learning models for assessing the assessment activity of students}\\
